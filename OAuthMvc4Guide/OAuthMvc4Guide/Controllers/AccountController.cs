...
using OAuthMvc4Guide.Filters;
using OAuthMvc4Guide.Models;

namespace OAuthMvc4Guide.Controllers
{
    [Authorize]
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                return View("ExternalLoginConfirmation", new RegisterExternalLoginModel
                {
                    ...
                    Birthday = DateTime.ParseExact(result.ExtraData["birthday"], "MM/dd/yyyy", System.Globalization.CultureInfo.InvariantCulture),
                    Email = result.ExtraData["email"],
                    Link = result.ExtraData["link"],
                    Verified = bool.Parse(result.ExtraData["verified"])
                });
            }
        }
